...
public class CResultado  implements java.io.Serializable {
    private org.correios.CServico[] servicos;

    public CResultado() {
    }

    public CResultado(
           org.correios.CServico[] servicos) {
     ...
     * @return servicos
     */
    public org.correios.CServico[] getServicos() {
        return servicos;
    }
     ...
     * @param servicos
     */
    public void setServicos(org.correios.CServico[] servicos) {
        this.servicos = servicos;
    }
